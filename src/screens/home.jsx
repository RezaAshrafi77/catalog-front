...
export const Home = ({ template, ...props }) => {
  ...
  return (
    <div className="flex flex-1 flex-col max-w-full max-h-full h-full overflow-hidden bg-black">
      <Image
      ...
      <div className="flex flex-col flex-center-center gap-8 z-50 backdrop-blur-lg px-[8vw] pt-8 pb-[6vh] rounded-t-3xl bg-black bg-opacity-20 overflow-hidden">
        <h1 className="text-white opacity-75 text-3xl font-medium mb-10">
          {template?.name}
        </h1>
        <Button
          key={0}
